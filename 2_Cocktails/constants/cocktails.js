...
const estiloStrAlcoholic = 'color: green; font-family: Arial, sans-serif;';



let cocktailsTotal = cocktails.length - 1
let twentyCocktails = cocktails.slice(cocktailsTotal - 20, cocktailsTotal)
for (let index = 0; index < twentyCocktails.length; index++) {
  const cocktail = twentyCocktails[index];
 
    document.getElementById("twentycocktails").innerHTML += "<tr><td onclick='elementos("+index+")'>" + cocktail.strDrink + "</td></tr>"
 }

function elementos (index) {
  const cocktail = twentyCocktails[index]
  document.getElementById("detalle").innerHTML = '<img src='+ cocktail.strDrinkThumb +'>' + " " + '<table><td>' + " " + cocktail.strIngredient1 + " "+ cocktail.strIngredient2+ " "+ cocktail.strIngredient3+ " "+ cocktail.strIngredient4+ " "+ cocktail.strIngredient5+ " "+ cocktail.strIngredient6+ " "+ cocktail.strIngredient7+ " "+ cocktail.strIngredient8+ " "+ cocktail.strIngredient9+ " "+ cocktail.strIngredient10+ " "+ cocktail.strIngredient11+ " "+ cocktail.strIngredient12+ " "+ cocktail.strIngredient13+ " "+ cocktail.strIngredient14+ " "+ cocktail.strIngredient15+ " "+ '</td></table>' + " " + "<h2>" + cocktail.strInstructions + "</h2>" + " "+ cocktail.strGlass+ " "+ "<span style='" + estiloStrAlcoholic + "'>" +" " + cocktail.strAlcoholic + "</span>";

if (cocktail.value == null){document.getElementById("twentycocktails").innerHTML= " "}
}
